...
export const MOCK_CUISINE_GUIDES: CuisineGuideItem[] = [
  ...
  },
  {
    ...
    coverUrl: 'https://images.unsplash.com/photo-1559847844-5315695dadae?auto=format&fit=crop&w=360&h=140&q=65',
    isPublished: true,
  ...
  },
  {
    ...
    coverUrl: 'https://images.unsplash.com/photo-1541696490-8744a5dc0228?auto=format&fit=crop&w=360&h=140&q=65',
    isPublished: false,
  ...
  // useful for a learner to open yet; publish once SKUs are filled in.
  {
    ...
    coverUrl: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?auto=format&fit=crop&w=360&h=140&q=65',
    isPublished: false,
  ...
  },
  {
    ...
    coverUrl: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=360&h=140&q=65',
    isPublished: false,
    createdAt: new Date('2026-09-07'),
    updatedAt: new Date('2026-09-07'),
    skus: [],
  ...
  },
  {
    ...
    coverUrl: 'https://images.unsplash.com/photo-1556910103-1c02745aae4d?auto=format&fit=crop&w=360&h=140&q=65',
    isPublished: false,
    createdAt: new Date('2026-09-07'),
    updatedAt: new Date('2026-09-07'),
    skus: [],
